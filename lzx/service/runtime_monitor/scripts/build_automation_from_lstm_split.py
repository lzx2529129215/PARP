...
REPO_ROOT = Path(__file__).resolve().parents[4]  # lzx-note
TEST_ROOT = REPO_ROOT / "test"  # lzx-note
OP_ROOT = REPO_ROOT / "lzx/tool/operation_predictor"  # lzx-note
SUPPORTED = {
...
def main() -> None:
    ...
    parser.add_argument("--output", default=str(TEST_ROOT / "configs/automation/test4_validation_sequence_108_4_60.json"))
    parser.add_argument("--coverage-output", default="")
    args = parser.parse_args()

    dataset = OP_ROOT / "data/test1/processed/app_lstm_duration_switch" / f"{args.split}.csv"
    ...
    templates, variables = load_templates(TEST_ROOT / "configs/automation/scenario_test1_app_switch.json")
