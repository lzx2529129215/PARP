...
LZX_ROOT = Path(__file__).resolve().parents[3]  # lzx-note
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--checkpoint",
        default=LZX_ROOT / "tool/operation_predictor" / "outputs" / "checkpoints" / "app_lstm_duration" / "lsapp_app_lstm_duration_switch.pt",
    )
    parser.add_argument("--app-vocab", default=LZX_ROOT / "tool/operation_predictor" / "data" / "vocab" / "app_vocab_duration.json")
    parser.add_argument("--group-vocab", default=LZX_ROOT / "tool/operation_predictor" / "data" / "vocab" / "user_group_vocab.json")
