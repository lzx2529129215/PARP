...
def main() -> int:
    ...
    config_path = PROJECT_ROOT / "configs/runtime/runtime_app_scope.json"; vocab_path = PROJECT_ROOT.parent / "tool/operation_predictor/data/vocab/app_vocab_duration.json"  # lzx-note
