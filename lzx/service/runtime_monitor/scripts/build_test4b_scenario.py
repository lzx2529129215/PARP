...
TEST_ROOT = Path(__file__).resolve().parents[4] / "test"  # lzx-note
MIB = 1024 * 1024
...
def main() -> None:
    ...
    parser.add_argument("--base-scenario", type=Path, default=TEST_ROOT / "configs/automation/test4_validation_sequence_108_4_60.json")
