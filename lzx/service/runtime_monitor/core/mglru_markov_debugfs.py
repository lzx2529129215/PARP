...
class MGLRUMarkovDebugfsWriter:
    def __init__(
        ...
        *,
        ...
        # lzx-note: Observe-only resident mode must not probe debugfs or invoke
        # sudo when the kernel writer is disabled.
        self.debugfs_exists = self._debugfs_exists() if self.enabled else False
