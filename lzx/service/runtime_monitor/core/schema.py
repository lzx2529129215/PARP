...
APP_STATE_1S_FIELDS = [
    ...
    "write_requested_bytes_1s",
    "read_bytes_1s",
    "write_bytes_1s",
    "read_error_cnt_1s",
    "write_error_cnt_1s",
    "read_latency_ns_sum_1s",
    "read_latency_ns_max_1s",
    "read_latency_ns_p95_1s",
    "write_latency_ns_sum_1s",
    "write_latency_ns_max_1s",
    "write_latency_ns_p95_1s",
    "lseek_cnt_1s",
    "sequential_read_ops_1s",
    "cyclic_read_ops_1s",
    "random_read_ops_1s",
    "unknown_offset_read_ops_1s",
    "read_access_pattern",
    "rchar_1s",
    "wchar_1s",
    "mmap_cnt_1s",
    ...
    "unique_inode_cnt_1s",
    "page_access_cnt_1s",
    "page_access_bytes_1s",
    "eviction_cnt_1s",
    "eviction_bytes_1s",
    "user_page_fault_cnt_1s",
    "attributed_block_io_cnt_1s",
