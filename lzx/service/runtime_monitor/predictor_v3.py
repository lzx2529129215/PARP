...
try:  # lzx-note
    from .layout import OPERATION_PREDICTOR_ROOT as DEFAULT_OPERATION_PREDICTOR_ROOT
except ImportError:  # lzx-note
    from layout import OPERATION_PREDICTOR_ROOT as DEFAULT_OPERATION_PREDICTOR_ROOT
OPERATION_PREDICTOR_ROOT = Path(
    os.environ.get("OPERATION_PREDICTOR_ROOT", DEFAULT_OPERATION_PREDICTOR_ROOT)
).resolve()
