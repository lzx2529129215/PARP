...
REPO_ROOT = ROOT.parent  # lzx-note
RUNTIME_CONFIG_ROOT = REPO_ROOT / "lzx/service/configs/runtime"  # lzx-note
...
def main() -> int:
    ...
    parser.add_argument("--runtime-scope-config", type=Path, default=RUNTIME_CONFIG_ROOT / "runtime_app_scope.json")
