...
SCENARIO:
  ...
  login-free-six  Calendar、Rhythmbox、Image Viewer、Shotwell、System Monitor、Solitaire # lzx-note
...
case "$scenario_key" in
  ...
  login-free-six) scenario="scenario_login_free_six_apps.json" ;; # lzx-note
  -h|--help) usage; exit 0 ;;
